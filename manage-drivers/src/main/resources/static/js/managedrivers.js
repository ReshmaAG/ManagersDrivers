...
/*function validateAndMoveExp(event){
	
	if(!(document.getElementById('lic-exp-date').value == undefined || document.getElementById('lic-exp-date').value == "") && event.keyCode == 13){
...
function formatValidation(){
	...
	//const driverNumberPattern = new RegExp("^(?([0-9]{3}))?[-. ]?([0-9]{3})[-. ]?([0-9]{4})$");
  	//var driverNumTrue = driverNumberPattern.test(document.getElementById('dri-num').value);
